...
public class UserController {
	...
	public String showContacts(@PathVariable("page") Integer page, Model m, Principal principal) {		// jb commented tarika use krenge tb model k sath Principle lga denge
